...
function prepend(value, list) { // what is this doing?
  return console.log({value: value, rest: list});
}

prepend(2, {value: 1, rest: { value: 2, rest: null } })
...
function deepEqual(a, b) {
  ...
  for (var prop in b) {
    propsInB += 1;
    if (!(prop in a) || !deepEqual(a[prop], b[prop])) // I understand this. above it checke if they were the same value
